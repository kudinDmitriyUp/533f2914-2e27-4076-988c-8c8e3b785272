...
export const metadata: Metadata = {
  title: "Yamada Resort - Japanese Mountain Sanctuary",
  description: "Experience premium hospitality in the Japanese Alps. Authentic mountain resort with private onsen, kaiseki dining, and breathtaking views.",
  keywords: "Japanese mountain resort, luxury hotel, onsen, Japanese Alps, mountain sanctuary",
  openGraph: {
    title: "Yamada Resort - Japanese Mountain Sanctuary",
    description: "Discover tranquility in our premium Japanese mountain resort",
    siteName: "Yamada Resort",
    type: "website",
  },
};
